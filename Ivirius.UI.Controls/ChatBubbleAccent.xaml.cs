...
{
    public sealed partial class ChatBubbleAccent : UserControl
    {
        public ChatBubbleAccent()
        {
        ...
        typeof(ChatBubbleAccent), // The type of the owner class
        ...
        {
            ((ChatBubbleAccent)d).DetectTextChange();
        }
